...
Another issue to consider are unknown words. In \gls{lvcsr} applications, \gls{oov} words are inevitable, so modern \gls{asr} system usually have some mechanisms of identifying them.
...
Two practical remarks are also in place.
