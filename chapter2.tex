...
\end{equation}
Entropy is maximised when all emission probabilities are equal, that is $P(x)=1/|V|$.
In case of language, the symbols are not emitted independently, so the entropy is given by:
\begin{equation}
