...
\end{equation}
	...
	\end{equation}
	where $w_{1}, \dots, w_{n}$ is a sufficiently long, previously unseen sequence called the test text. The probability estimates can never be better than the actual estimates, so $H$ is the lower bound for $\hat{H}$, therefore the.
\subsection{WERR}
