...
\begin{table}[h!]
	...
	\end{equation}
	Perplexity is equivalent to the weighted average branching factor of a language. A model with a perplexity of $2^{H}$ is as confused while predicting the next word as if it had to choose uniformly and independently from a set of $2^{H}$ words.
	\subsection{WERR}
