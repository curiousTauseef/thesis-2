...
Another way to look at the $n$-gram is to use the notion of equivalence class, already introduced in Section \ref{subsection:lm}. In \cite{jelinek1997statistical}, language modelling is defined as the task of finding the best history equivalence function:
\begin{equation}
	\Phi:w_{1}, \dots, w_{i-1}\mapsto\Phi=\phi(w_{1}, \dots, w_{i-1})
\end{equation}
