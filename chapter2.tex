...
\begin{table}[h!]
	...
	\begin{figure}[htbp]
		\centering
		\includesvg{rnn}
		\caption{A simple \gls{rnn} called an Elman network \cite{mikolov2011extensions}}
