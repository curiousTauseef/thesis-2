...
\begin{table}[!htbp]
	...
	\end{tabular*}
\end{table}
The n-gram counts were then smoothed and interpolated. Several smoothing method were tested~--~Good-Turing, Kneser-Ney, and Chen-Goodman. The last two smoothing methods also combined with 
