...
Figures \ref{figure:unigramdistribution}-\ref{figure:trigramdistribution} present the distribution of n-grams in the full plain corpus on a double logarithmic plot. Zipf's law states that the rank-frequency distribution of words in a natural language corpus is an inverse relation. More formally, the probability mass function of the term frequencies is of the form:
\begin{equation}
	p=\alpha k^{-\beta},
	\label{equation:zipf}
\end{equation}
where $k$ is the rank of the term (from the most to the least frequent one), and $(\alpha, \beta)$ are distribution parameters.
 

\begin{figure}[!htbp]
	  \centering
	  \includegraphics[height=10cm, width=15cm]{unigrams.png}
      \caption{Unigram distribution in the full plain corpus.}
...
\begin{figure}[!htbp]
      ...
      \caption{Bigram distribution in the full plain corpus.}
      \label{figure:unigramdistribution}
\end{figure}
...
\begin{figure}[!htbp]
      ...
      \caption{Trigram distribution in the full plain corpus.}
      \label{figure:unigramdistribution}
\end{figure}
