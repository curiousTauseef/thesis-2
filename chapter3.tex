...
\begin{enumerate}
	...
	\item GNC tags -- tags containing information about the grammatical class and selected grammatical categories that were shown in \cite{pohl2013using} to offer significant improvements over the POS-only model (gender, number, case).
\end{enumerate}
