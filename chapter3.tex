...
For the purpose of the experimental part of this thesis, the redistributable subcorpus was used. It consists of all text of the full \gls{nkjp} that are free from intellectual property constraints. The sources of the texts are mostly parliamentary proceedings and legal texts (see Table \ref{table:freenkjp}).
