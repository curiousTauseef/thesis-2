...
%\begin{figure}[!htbp]
%	  \centering
%	  \includesvg[height=10cm, width=15cm, svgpath=./img/]{unigrams}
...
%\begin{figure}[!htbp]
%	  \centering
%	  \includesvg[height=10cm, width=15cm, svgpath=./img/]{bigrams}
...
%\begin{figure}[!htbp]
%	  \centering
%	  \includesvg[height=10cm, width=15cm, svgpath=./img/]{trigrams}
%	      \caption{Most common bigrams of the plain full corpus.}
