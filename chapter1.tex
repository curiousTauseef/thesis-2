...
Polish, like other Slavic languages, exhibits a very large degree of inflection. This means that lexical units modify their basic form depending on grammatical, morphological and contextual relations. Inflection helps to infer the grammatical category (number, case, aspect, etc.) of a word. Nouns, pronouns, adjectives, and numerals
