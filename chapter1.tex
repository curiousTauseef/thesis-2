...
\end{equation}
Another property of the human hearing is that it is less sensitive to variation in signal level at high amplitudes. To model that response, the logarithm of each of the mel spectrum values is taken.
